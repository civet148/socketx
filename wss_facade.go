...
import (
	...
	_ "github.com/civet148/socketx/tcpsock"  //required (register socket instance)
	_ "github.com/civet148/socketx/udpsock"  //required (register socket instance)
	_ "github.com/civet148/socketx/unixsock" //required (register socket instance)
	_ "github.com/civet148/socketx/websock"  //required (register socket instance)
	"strings"
)
